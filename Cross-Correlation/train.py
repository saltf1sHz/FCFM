...
from support_deal import load_all_data, preprocess
from support_initialize import initialize_train
from torch.utils.tensorboard import SummaryWriter

log_dir = os.path.join(r'D:\Zang\Deaplearn_Tensorborad', datetime.now().strftime("2024"))
...
if __name__ == "__main__":
    ...
    parser.add_argument('-ep', '--max_epoch', type=int, default=1200)
    ...
    parser.add_argument('-iep', '--init_max_epoch', type=int, default=1200)
    ...
    """ all_files = load_all_data(args.folder_path)
    train_array, val_array = train_test_split(all_files, test_size=VAL_RATIO, random_state=args.seed)
    train_dataset = AtomDataset(train_array)
    val_dataset = AtomDataset(val_array)

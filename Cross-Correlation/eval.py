...
from support_deal import load_data, preprocess, minmax_norm, minmax_denorm
...
if __name__ == "__main__":
    ...
    data_path = r"C:\Users\lonel\OneDrive\软件\DeepLearn\Val_data\6.csv"
    ...
    G0, Td, s = real_params.cpu().numpy()
    print(f'G0: {G0}, Td: {Td}, s: {s}')
    # mse_loss = nn.MSELoss()(data[:, 1], y_prime)
    mse_loss = 2
    # Cl_loss= ClLoss(deal_data[:, 0], deal_data[:, 1], *params)
    print(mse_loss)
    ...
    ax.set_xscale('log')
    ax.legend()
    # plt.title("MSE_Loss" + str(mse_loss.item()))

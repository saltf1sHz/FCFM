...
log_dir = os.path.join(r'D:\Zang\Deaplearn_Tensorborad', datetime.now().strftime("float"))
...
if __name__ == "__main__":
    ...
    parser.add_argument('-ep', '--max_epoch', type=int, default=800)
    parser.add_argument('-wd','--weight_decay', type=float, default=1e-5)
    parser.add_argument('-sd','--seed', type=int, default=65536)
    ...
    parser.add_argument('-iep', '--init_max_epoch', type=int, default=800)
    ...
    val_norm_inputs, val_norm_params, val_y_min = preprocess(val_data)
    ...
    for ep in pbar:
        ...
        norm_train_inputs, norm_params, y_min = preprocess(train_data)       
